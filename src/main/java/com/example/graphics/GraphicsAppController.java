...
//Zusatzaufgabe keinen Text im Textfeld
...
public class GraphicsAppController {
    public Label labelCirumference;
    ...
    public void buttonClicked(MouseEvent mouseEvent) {
        ...
        Rectangular rectangular = new Rectangular(1,1,width, height);

        labelCirumference.setText(Double.toString(rectangular.computeCirumference()));
        labelArea.setText(Double.toString(rectangular.computeArea()));
    }
